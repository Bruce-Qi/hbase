...
public class TestHbase {
   public static Connection conn = null;
    ...
    public void setup() throws IOException {
        ...
        conf.set("hbase.zookeeper.quorum", "192.168.44.137,192.168.44.138,192.168.44.139");
    ...
    public void find() throws IOException {
        Table table = conn.getTable(test);
        Scan scan = new Scan("13891355243_20163812254".getBytes(),"13891780191_201682782417".getBytes());
...
//        get.addColumn("cf1".getBytes(),"name".getBytes());
    ...
    public String getRowKey(String pre){
        return pre+ ra.nextInt(99999999)+"_2017"+ra.nextInt(12)+ra.nextInt(30)+ra.nextInt(24)+ra.nextInt(60)+ra.nextInt(60);
    }
